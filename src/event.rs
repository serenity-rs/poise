...
event! {
    ...
    guild_member_addition => GuildMemberAddition { new_member: Member },
    ...
    guild_role_create => GuildRoleCreate { new: Role },
    guild_role_delete => GuildRoleDelete { guild_id: GuildId, removed_role_id: RoleId, removed_role_data_if_available: Option<Role> },
    guild_role_update => GuildRoleUpdate { old_data_if_available: Option<Role>, new: Role },
    ...
    presence_update => PresenceUpdate { new_data: Presence },
    ...
    voice_state_update => VoiceStateUpdate { old: Option<VoiceState>, new: VoiceState },
