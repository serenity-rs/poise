...
event! {
    ...
    guild_create => GuildCreate { guild: serenity::Guild, is_new: Option<bool> },
    ...
    guild_member_update => GuildMemberUpdate { old_if_available: Option<serenity::Member>, new: Option<serenity::Member>, event: serenity::GuildMemberUpdateEvent },
    ...
    user_update => UserUpdate { old_data: Option<serenity::CurrentUser>, new: serenity::CurrentUser },
